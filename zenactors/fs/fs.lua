...
if not ... then require'zen.zenactors.fs.fs_test'; return end

local ffi = require'ffi'
setfenv(1, require'zen.zenactors.fs.fs_common')

if win then
	require'zen.zenactors.fs.fs_win'
elseif linux or osx then
	require'zen.zenactors.fs.fs_posix'
else
